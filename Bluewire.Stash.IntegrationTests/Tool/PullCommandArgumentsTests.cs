...
{
    [TestFixture]
    public class PullCommandArgumentsTests
    {
        [Test]
        public void ParsesVersionOrHashArguments()
        {
            ...
            app.Execute("pull", "teststash", "remotestash", "--version", "21.01.4-beta", "--hash", "some-hash");

            var model = application.Invocations.OfType<PullArguments>().SingleOrDefault();
        ...
        public void ParsesIdentifierArguments()
        {
            ...
            var app = Program.Configure(application);
            app.Execute("pull", "teststash", "remotestash", "--identifier", "some-hash:21.01.4-beta");
